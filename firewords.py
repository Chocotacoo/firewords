...
def print_firewords():
    ...
    print("\u001b[33;1m                         8*            *  ")
    print("\u001b[33;1m                        88*           8*  ")
    print("\u001b[33;1m            p         888*          88*  ")
    print("\u001b[33;1m            8p        d888*         d88*  ")
    print("\u001b[33;1m           d8p       ad888*        ad88*  ")
    print("\u001b[33;1m          dd8P     dad8888*       dad88*  ")
    print("\u001b[33;1m         d888P    d88888*     ,,ad8888P*  ")
    print("\u001b[33;1m    d   d888P   a88888P*  ,ad8888888*     ")  
    print("\u001b[33;1m  .d8  d8888:  d888888* ,d888888P*        ")  
    print("\u001b[33;1m .888; 88888b d8888888b8888888P            \u001b[35m FIREWORDS  ")
    print("\u001b[31m  d8888J888888a88888888888888P*    ,d      ")
    print("\u001b[31m 88888888888888888888888888P   ,,d8*     \u001b[35m CREATED BY JERICO M ")
    print("\u001b[31m 888888888888888888888888888888888*      \u001b[35m VERSION 1.0 ")
    print("\u001b[31m *8888888888888888888888888888888*        ")
    print("\u001b[31m  Y888888888P* `*``*888888888888*         ")
    print("\u001b[31m   *^888^*8888888888*Y888P**8888          ")
...
def version():
    ...
    print("\r\n	\033[1;32m[ firewords.py ]  " + __version__ + "\033[1;m\r\n")
    print("	* Created by Jerico M")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in firewords.cfg too...
    ...
    print_to_file(file_to_open + ".firewords.txt", unique_list_finished)
...
def interactive():
    ...
    print("\r\n\033[1;32m[+] Insert the information about the victim to make a dictionary")
    ...
    if words1 == "y":
        words2 = input(
            "> Please enter the words, separated by comma. [i.e. love,juice,black], spaces will be removed: "
        ).replace(" ", "")
...
# the main function
def main():
    """Command-line interface to the firewords utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "firewords.cfg"))
